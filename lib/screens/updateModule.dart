...
class updateModule extends StatefulWidget {
  int index;
  String grade1, credit1, sem;
  updateModule(this.sem, this.index, this.credit1, this.grade1);

  @override
  _updateModule createState() => _updateModule(grade1, credit1);
}

class _updateModule extends State<updateModule> {
  final String gradeMod, creditMod;
  _updateModule(this.gradeMod, this.creditMod);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          moduleController.text = docs[widget.index]['module'].toString();
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      await FirebaseFirestore.instance
                          ...
                          .doc(uid)
                          .collection('sem0' + widget.sem)
                          .doc(docs[widget.index]['moduleID'])
                          .update({
                        ...
                        Fluttertoast.showToast(
                          msg: "Module Info Updated",
                        );
                        debugPrint('updated module');
                        ...
                        debugPrint(
                            'Totcredits:' + newCredits.toStringAsFixed(2));
